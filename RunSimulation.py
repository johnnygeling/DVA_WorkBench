...
class cmd_runMcSimulation():
    ...
    def Activated(self):
        ...
        if hasattr(selected_object, "AnalysisType"):
                
            FilePath = selected_object.OutputFile
            Repet = selected_object.Sample
            ...
            Mesure = selected_object.ListPoints
            ...
            print('selected object is not a DVA group')
        return
